...
abstract class ReplyByEmailUtilityDomain extends Gdn_Plugin {
...
class ReplyByEmailUtility {
  ...
  public static function Load($Class){
    ...
    foreach ($Maps As $Map){
      ...
      if(preg_match($Map['Match'],$Class,$Matches)){
        ...
        require_once(PATH_PLUGINS.DS.'ReplyByEmail'.($Map['Folder'] ? DS.$Map['Folder']: '').DS.$Map['File']);
        break;
      }
    }
  }
  ...
  public static function InitLoad(){
    //ensure
    spl_autoload_register('ReplyByEmailUtility::Load');
  }
